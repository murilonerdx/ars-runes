...
public class ArcaneHarvestBenchScreen extends AbstractContainerScreen<ArcaneHarvestBenchMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(RuinaArcanaMod.MOD_ID, "textures/gui/arcane_harvest_bench.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, Component.translatable("screen.ruinaarcana.arcane_harvest_bench.charge", menu.getCharge(), menu.getMaxCharge()), 105, 42, 0x5B4A63, false);
        guiGraphics.drawString(this.font, Component.translatable(menu.isLinked() ? "screen.ruinaarcana.arcane_harvest_bench.linked" : "screen.ruinaarcana.arcane_harvest_bench.unlinked"), 105, 70, menu.isLinked() ? 0x2D7A52 : 0x8A3B4A, false);
        guiGraphics.drawString(this.font, Component.translatable("screen.ruinaarcana.arcane_harvest_bench.stored", menu.getStoredStacks()), 105, 84, 0x5B4A63, false);
